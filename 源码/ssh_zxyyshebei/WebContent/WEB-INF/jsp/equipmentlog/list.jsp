...
<div class="page-content clearfix">
        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><input name="equipment.xh" type="text" value="${equipmentLog.equipment.xh}" class="text_add"  style=" width:150px" placeholder="设备型号"/></li>
                    <li><input name="user.name" type="text" value="${equipmentLog.user.name}" class="text_add"  style=" width:150px" placeholder="借用人"/></li>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/equipmentlog_list.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="15"
                  export="curPage=pageNumber">
            <pg:param name="equipment.xh" value="${equipmentLog.equipment.xh}"/>
            <pg:param name="user.name" value="${equipmentLog.user.name}"/>
            <pg:last>
