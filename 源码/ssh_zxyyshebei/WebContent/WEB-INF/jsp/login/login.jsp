...
<link rel="stylesheet"
	href="${ctx}/resource/assets/css/ace-skins.min.css" />
...
<body class="login-layout Reg_log_style">
	...
	<div class="loginbody">
		<div class="login-container">
			<div class="center">
				<img src="${ctx}/resource/images/logo1.png" />
			</div>

			<div class="space-6"></div>

			<div class="position-relative">
				<div id="login-box" class="login-box widget-box no-border visible" style="height: 320px">
					<div class="widget-body">
						<div class="widget-main">
							...
							<div class="login_icon">
								<img src="${ctx}/resource/images/login.png" />
							</div>
								...
								<fieldset>
									<ul>
										<li class="frame_style form_error"><label
											class="user_icon"></label> <input name="user.name"
											type="text" id="用户名" /><i>用户名</i></li>
										<li class="frame_style form_error"><label
											class="password_icon"></label><input name="user.pass"
											type="password" id="密码" /><i>密码</i></li>
						...
						<div class="social-login center">推荐使用Chrome浏览器打开本页面</div>
					</div>
					<!-- /widget-main -->
