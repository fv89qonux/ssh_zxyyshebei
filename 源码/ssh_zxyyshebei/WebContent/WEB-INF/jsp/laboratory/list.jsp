        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><input name="name" type="text" value="${laboratory.name}" class="text_add"  style=" width:150px" placeholder="实验室名称"/></li>
                    <li><input name="fzr" type="text" value="${laboratory.fzr}" class="text_add"  style=" width:150px" placeholder="负责人"/></li>
