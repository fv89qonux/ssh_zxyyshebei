        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><input name="xh" type="text" value="${bean.xh}" class="text_add"  style=" width:150px" placeholder="设备型号"/></li>
                    <li><input name="zzs" type="text" value="${bean.zzs}" class="text_add"  style=" width:150px" placeholder="设备制造商"/></li>
                    <li><input name="sbxlh" type="text" value="${bean.sbxlh}" class="text_add"  style=" width:150px" placeholder="设备序列号"/></li>
...
<form action="repair_repair.do" method="post" class="form form-horizontal" id="form-user-add" >
    ...
    <div class="add_menber" id="add_menber_style" style="display:none">
        <ul>
            <li><label class="label_name" style="width: 130px">报修标题：</label>
                <span class="add_name">
                <input value="" name="repairLog.title" type="text" id="报修标题" class="text_add"/>
            </span>
            </li>
            <li>
            ...
            <li>
                ...
                <select name="repairLog.equipment.id" style="width: 165px; margin-left: 10px" class="text_add">
                    <option value="" id="设备型号">请选择</option>
