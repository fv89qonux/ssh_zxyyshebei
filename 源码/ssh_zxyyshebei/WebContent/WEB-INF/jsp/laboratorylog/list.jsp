        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><input name="laboratory.name" type="text" value="${laboratoryLog.laboratory.name}" class="text_add"  style=" width:150px" placeholder="实验室名称"/></li>
                    <li><input name="user.name" type="text" value="${laboratoryLog.user.name}" class="text_add"  style=" width:200px" placeholder="预约人"/></li>
